...
//!
//! A [`Normalized`] array stores a tensor or vector column as two non-nullable children plus its
//! own validity:
//!
//! - `normalized`, a tensor-like column whose rows are unit-norm (or zero),
//! - `norms`, a primitive float column holding the authoritative L2 norm of each row, and
//! - `validity`, the column's null map.
//!
